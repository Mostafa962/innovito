<div id="tabs-6">
    <form method="post" class="create_lesson_form" data-lesson-type-id="6" id="lesson-type-id-6" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group label-floating">
            ...
            <input class="form-control" placeholder="Lesson Video" type="file" name="localvideo_link" accept="video/*" required>
        </div>
