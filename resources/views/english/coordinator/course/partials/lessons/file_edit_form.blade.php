        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="edit_lesson_form" data-lesson-id="{{$lesson->id}}" id="edit-lesson-content-{{$lesson->id}}" enctype="multipart/form-data">
                    ...
                    <a target="_blank" href="{{asset('') . $lesson->content->localvideo_link}}" >Current File</a>
                    <div class="form-group label-floating">
                        <label class="control-label">Lesson File (.pdf/.pptx/.docx)</label>
                        <input class="form-control" placeholder="Lesson File" type="file" name="localvideo_link" accept="application/pdf,application/vnd.ms-excel" >
                    </div>
