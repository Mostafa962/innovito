        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="edit_lesson_form" data-lesson-id="{{$lesson->id}}" id="edit-lesson-content-{{$lesson->id}}" enctype="multipart/form-data">
                    ...
                    <a target="_blank" href="{{asset('') . $lesson->content->localvideo_link}}" >Current Video</a>
                    <div class="form-group label-floating">
                        <label class="control-label">Lesson Video</label>
                        <input class="form-control" placeholder="Lesson Video" type="file" name="localvideo_link" accept="video/*">
                    </div>

                    <div class="form-group label-floating">
                        <label class="control-label">Lesson Duraion </label>
                        <input class="form-control" placeholder="hours : minutes : seconds (ex: 01:25:34)" name="video_duration" pattern="[0-9]{2}[:][0-9]{2}[:][0-9]{2}" type="text" required value="{{$lesson->content->video_duration}}">
                    </div>
