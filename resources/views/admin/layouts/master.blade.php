...
<head>
  ...
  <title>INNOVITO | Control Panel</title>
  ...
  <!-- image-picker-master -->
  <link rel="stylesheet" href="{{asset('/plugins/image-picker-master/image-picker/image-picker.css')}}">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{asset('/plugins/adminlte/plugins/bootstrap-slider/slider.css')}}">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{asset('/plugins/adminlte/dist/css/AdminLTE.min.css')}}">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect. -->
  <link rel="stylesheet" href="{{asset('/plugins/adminlte/dist/css/skins/skin-black.min.css')}}">
...
<body class="hold-transition skin-black sidebar-mini">
  ...
  <!-- Image-Picker -->
  <script src="{{asset('/plugins/image-picker-master/image-picker/image-picker.js')}}"></script>
  <script src="{{asset('/plugins/image-picker-master/image-picker/image-picker.min.js')}}"></script>
  <!-- iCheck 1.0.1 -->
  <script src="{{asset('/plugins/adminlte/plugins/iCheck/icheck.min.js')}}"></script>
  <!-- CK Editor -->
  <script src="{{asset('/plugins/adminlte/bower_components/ckeditor/ckeditor.js')}}"></script>
  ...
  <!-- Bootstrap slider -->
  <script src="{{asset('/plugins/adminlte/plugins/bootstrap-slider/bootstrap-slider.js')}}"></script>
  <script>
    $.ajaxSetup({
      headers: {
