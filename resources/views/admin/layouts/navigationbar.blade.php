  ...
  <header class="main-header">
    ...
    <a href="{{route('en.home.index')}}" class="logo">
      ...
      <span class="logo-lg"><b>INNOVIT</b>O</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="{{ route('admin.home.logout') }}" class="btn btn-default btn-flat" onclick="event.preventDefault();
                  document.getElementById('logout-form').submit();">Sign out</a>
                  <form id="logout-form" action="{{ route('admin.home.logout') }}" method="POST" style="display: none;">
                      @csrf
                  </form>
                </div>
              </li>
